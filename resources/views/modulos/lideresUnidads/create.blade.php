...
@section('title', 'Asignar lider de unidad')
        ...
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                <div class="flex justify-between items-center mb-4">
                    <div>
                        <h1 class="card-title text-2xl">Crear lidere de unidad produvtiva</h1>
                        <p class="text-sm text-base-content/70">Formulario para registrar un nuevo lideres de unidad produvtiva</p>
                    </div>
                    <a href="{{ route('lideresUnidads.index') }}" class="btn btn-secondary btn-md gap-2">
                ...
                <form action="{{ route('lideresUnidads.store') }}" method="POST">
                    @csrf

                    <div class="form-control mb-4" x-data="dropdown()">
                        <label class="label block" for="area_search">
                            <span class="label-text font-medium">Unidad productiva *</span>
                        </label>
                        ...
                        <input type="hidden" name="unidades_productiva_id" :value="selected?.id" required>
    ...
    <script>
        function dropdown() {
            return {
                ...
                open: false,
                selected: null,
                areas: @json($unidadesProductivas->map(function($area) {
