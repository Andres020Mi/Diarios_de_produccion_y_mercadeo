        ...
        <div class="bg-base-100 p-6 rounded-xl shadow-lg">
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <p class="text-sm text-base-content/70">Lista del inventario de mercadeo</p>
                </div>
                <a href="{{ route('inventarioMercadeo.create') }}" class="btn btn-primary btn-md gap-2">
                    ...
                    <tbody>
                        @forelse ($productos as $producto)
                            <tr class="hover:bg-base-200">
                                ...
                                <td class="max-w-xs whitespace-normal break-words text-sm text-base-content">
                                    {{ $producto->producto->unidad_de_medida_mercadeo }}
                                </td>
                              
                                <td>
                                    @if ($producto->producto->imagen)
                                        <div class="group w-16 h-16 relative overflow-visible">
                                            <img src="{{ asset('storage/' . $producto->producto->imagen) }}"
                                ...
                                <td class="flex gap-2">
                                    ...
                                    {{-- Editar --}}
                                    <a href="{{ route('inventarioMercadeo.edit', $producto->id) }}"
    ...
    @section('scripts')
        <script>
            ...
            function showDeleteModal(id) {
                ...
                form.action = `/inventarioMercadeo/${id}/destroy`;
                modal.showModal();
            }
        </script>
    @endsection
