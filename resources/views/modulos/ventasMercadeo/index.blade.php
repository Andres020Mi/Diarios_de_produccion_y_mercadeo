    ...
    <div class="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-base-100 p-6 rounded-xl shadow-lg">
            <div class="flex justify-between items-center mb-4">
                <div>
                    <h1 class="text-2xl font-bold text-base-content">Ventas de mercadeo</h1>
                    <p class="text-sm text-base-content/70">Ventas realizadas en punto de venta</p>
                </div>
                <a href="{{ route('ventasMercadeo.create') }}" class="btn btn-primary btn-md gap-2">
                ...
                <table class="table table-zebra w-full text-sm">
                    <thead>
                        <tr class="text-base-content/80">
                            ...
                            <th class="text-left">Valor de la venta</th>
                    ...
                    <tbody>
                        @forelse ($ventas as $venta)
                            <tr class="hover:bg-base-200">
                                ...
                                <td class="max-w-xs whitespace-normal break-words text-sm text-base-content">
                                    {{ $venta->producto->unidad_de_medida_mercadeo }}
                                </td>
                                ...
                                <td class="flex gap-2">
                                    {{-- Ver --}}
                                    <button onclick="showModal({{ $venta->id }})"
                                    ...
                                    {{-- Editar --}}
                                    <a href="{{ route('ventasMercadeo.edit', $venta->id) }}"
                                    ...
                                    {{-- Eliminar --}}
                                    <button onclick="showDeleteModal({{ $venta->id }})"
    ...
    @section('scripts')
        <script>
            ...
            function showDeleteModal(id) {
                ...
                form.action = `/ventasMercadeo/${id}/destroy`;
                modal.showModal();
            }
        </script>
    @endsection
