        ...
        <div class="bg-base-100 p-6 rounded-xl shadow-lg">
            <div class="flex justify-between items-center mb-4">
                <div>
                    ...
                    <p class="text-sm text-base-content/70">Gestión de registros de insumos existentes</p>
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="table table-zebra w-full text-sm">
                    ...
                    <tbody>
                                ...
                                <td>
                                    @if ($insumo->imagen)
                                        <div class="group w-16 h-16 relative overflow-visible">
                                            <img src="{{ asset('storage/' . $insumo->imagen) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center py-6 text-base-content/50">No hay insumos
                                    registrados.</td>
                            </tr>
                        @endforelse
                    </tbody>
