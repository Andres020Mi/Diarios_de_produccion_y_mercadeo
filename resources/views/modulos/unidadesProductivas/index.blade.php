    ...
    <div class="p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div class="bg-base-100 p-6 rounded-xl shadow-lg">
            <div class="flex justify-between items-center mb-4">
                <div>
                    <h1 class="text-2xl font-bold text-base-content">Unidades Productivas</h1>
                    <p class="text-sm text-base-content/70">Gestión de registros de unidades productivas existentes</p>
                </div>
                <a href="{{ route('unidadesProductivas.create') }}" class="btn btn-primary btn-md gap-2">
                        ...
                        @forelse ($unidadesProductivas as $unidad)
                            <tr class="hover:bg-base-200">
                                ...
                                <td class="flex gap-2">
                                    ...
                                    {{-- Editar --}}
                                    <a href="{{ route('unidadesProductivas.edit', $unidad->id) }}"
    ...
    @section('scripts')
        <script>
            ...
            function showDeleteModal(id) {
                ...
                form.action = `/unidadesProductivas/${id}/destroy`;
                modal.showModal();
            }
        </script>
    @endsection
